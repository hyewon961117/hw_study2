...
kings <- read.csv('C:/workspace/hw_study3/data/time/kings.dat',header=F)
kings
...
# 이동평균
# (1차) 1050+1000의 평균, 1050+1010의 평균, 1010+1020의 평균, 1020+1040의 평균
...
# 정상성(stationary) : 모든 시점에 평균이 일정한 특성 시간에 따라 확률적인 성분이 변하지 않는다는 가정, 정상성이 없으면 차분, 이동평균 등을 사용하여 변환
